...
enum class BooleanSetting(
    ...
    PERFORMANCE_HINTS(SettingKeys.use_performance_hints(), Settings.SECTION_RENDERER, true),
    ...
    MALI_GPU_OPTIMIZATIONS(SettingKeys.mali_gpu_optimizations(), Settings.SECTION_RENDERER, false),
    PARALLEL_SHADER_COMPILATION(SettingKeys.parallel_shader_compilation(), Settings.SECTION_RENDERER, true),
    ASYNC_TEXTURE_LOADING(SettingKeys.async_texture_loading(), Settings.SECTION_RENDERER, true),
